...
class Tribute:
    ...
    def __init__(self, nme, dist, inj):
        ...
        self.dead = False
        self.asleep = False
        self.hasPoisonPotato = False
        self.hasKnife = False
        self.hasBow = False
        self.hasFlowers = False
    ...
    if num == 0:
        ...
        if (tribute1.hasKnife == True):
            if (tribute1.inj == True and tribute2.inj == False):
                ...
                print ("{} stabs {} with a knife and kills {}.".format(t1, t2, tribute2.himher))
                tribute1.kills += 1
                tribute2.dead = True
            ...
            print ("{} tries to shank {}, but {} does not have a knife. What a dumbass.".format(t1, t2, t1))
    elif num == 4:
        ...
        if (tribute1.hasBow == True):
            ...
            print ("{} tries to shoot {} with an arrow, but {} does not have a bow or any arrows. What a dumbass.".format(t1, t2, t1))
    elif num == 7:
        if (tribute1.inj == True):
            print ("{} picks up some medicine and uses it to heal {}self.".format(t1, tribute1.himher))
            tribute1.inj = False
        else:
            tribute1.hasMedicine = True
            print ("{} picks up some medicine and keeps it for later.".format(t1))
    elif num == 8:
        ...
        if (tribute1.hasSword == True):
            ...
            print ("{} swings an imaginary sword at {}. This does nothing".format(t1, t2))
    elif num == 11:
        ...
        if tribute2.inj == True and temp != 3:
            ...
            print("{} throws a rock at {}'s face but misses.".format(t1, t2))
        ...
        if temp == 0:
            tribute1.hasKnife = True
            print ("{} recieves a supply drop from an unknown sponsor. Inside, there is a knife.".format(t1))
        if temp == 1:
            tribute1.hasBow = True
            print ("{} recieves a supply drop from an unknown sponsor. Inside, there is a bow.".format(t1))
        if temp == 2:
            tribute1.hasFlowers = True
            print ("{} recieves a supply drop from an unknown sponsor. Inside, there are some flowers.".format(t1))
        if temp == 3:
            tribute1.hasMedicine = True
            print ("{} recieves a supply drop from an unknown sponsor. Inside, there is some medicine.".format(t1))
        if temp == 4:
            tribute1.hasSword = True
            print ("{} recieves a supply drop from an unknown sponsor. Inside, there is a sword.".format(t1))
    elif num == 16:
        ...
        if tribute2.hasFlowers == True:
            print ("{} begs for mercy from {}. {} allows it because {} gave {} flowers.".format(t2, t1, tribute1.heshe, t2, tribute1.himher))
            tribute2.hasFlowers == False
        if tribute2.hasFlowers == False:
            print ("{} begs for mercy from {}, but {} is in no mood and strangles {}.".format(t1, t2, t2, tribute1.himher))
            tribute2.kills += 1
            tribute1.dead = True
            #tributes.remove(tribute1)
            dead.append(tribute1)
        ...
        tribute1.hasPoisonPotato = True
    elif num == 24:
        print ("{} carves {} initials into a tree".format(t1, tribute1.hisher))
    elif num == 25:
        if tribute1.hasSword == True and tribute2.hasSword == True:
            if tribute1.inj == True and tribute2.inj == True:
                ...
                dead.append(tribute2)
                deadthisday.append(tribute2)
            elif tribute1.inj == True and tribute2.inj == False:
                print ("{} gets in a swordfight with {}, and loses.".format(t1, t2))
                tribute2.kills += 1
                tribute1.dead = True
                #tributes.remove(tribute1)
                ...
                if temp == 0:
                    ...
                    dead.append(tribute2)
                    deadthisday.append(tribute2)
        elif tribute1.hasSword == False and tribute2.hasSword == True:
            print ("{} tries to steal {}'s sword, but {} stabs them instead.".format(t1, t2, t2))
            tribute2.kills += 1
            tribute1.dead = True
            #tributes.remove(tribute1)
            dead.append(tribute1)
            deadthisday.append(tribute1)
        elif tribute1.hasSword == True and tribute2.hasSword == False:
            print ("{} stabs {} with a sword.".format(t1, t2))
            tribute1.kills += 1
            tribute2.dead = True
            #tributes.remove(tribute2)
            dead.append(tribute2)
            deadthisday.append(tribute2)
        elif tribute1.hasSword == False and tribute2.hasSword == False:
            print ("{} and {} get into a fist fight.".format(t1, t2))
            tribute1.inj = True
            tribute2.inj = True
    elif num == 26:
        print ("{} caves {}'s skull in with a big wood stick".format(t1, t2))
        tribute1.kills += 1
        tribute2.dead = True
        #tributes.remove(tribute2)
        dead.append(tribute2)
        ...
        print ("{} stabs {} in the heart with a sharp stick.".format(t1, t2))
        tribute1.kills += 1
        tribute2.dead = True
        #tributes.remove(tribute2)
        dead.append(tribute2)
        ...
        if temp == 8:
            ...
            if tribute1.inj == True:
                print ("{} throws a rock at {}'s face, misses, and gets punched in the face. This kills {}.".format(t1, t2, tribute1.himher))
                tribute2.kills += 1
                tribute1.dead = True
                #tributes.remove(tribute1)
                dead.append(tribute1)
                ...
                print ("{} throws a rock at {}'s face, misses, and gets punched in the face.".format(t1, t2, tribute1.himher))
                tribute1.inj = True
        else:
        ...
        print ("Ghouls and Ghosts")
        tribute1.dead = True
        #tributes.remove(tribute1)
        dead.append(tribute1)
        deadthisday.append(tribute1)
    elif num == 43:
        print ("{} builds a shank out of a sharp rock and a stick".format(t1))
        tribute1.knife = True
    if (tribute1.hasMedicine == True and tribute1.inj == True):
        print ("{} heals {}self".format(t1, tribute1.himher))
        tribute1.hasMedicine = False
        tribute1.inj = False
...
def pickRandomNightAction(tribute1, tribute2):
    ...
    if num == 0:
        ...
        if tribute2.asleep == True:
            ...
            deadthisday.append(tribute2)
            tribute1.kills += 1
        elif tribute1.hasKnife == True:
            print ("{} sneaks up on {} and stabs {} to death with {} knife.".format(t1, t2, tribute2.himher, tribute1.hisher))
            tribute2.dead = True
            #tributes.remove(tribute2)
            dead.append(tribute2)
            deadthisday.append(tribute2)
            ...
            print ("{} sneaks up on {} and stabs {} to death with {} sword.".format(t1, t2, tribute2.himher, tribute1.hisher))
            tribute2.dead = True
            #tributes.remove(tribute2)
            dead.append(tribute2)
            deadthisday.append(tribute2)
            ...
            print ("{} tries to sneak up to {} but {} was awake and injured {}".format(t1, t2, t2, tribute1.himher))
            tribute1.inj = True
    elif num == 4:
        ...
        elif tribute2.hasPoisonPotato == True:
            print ("{} eats a poison potato {} gave {}.".format(t1, t2, tribute1.himher))
            tribute1.inj = True
        else:
            print ("{} eats a potato.".format(t1))
    elif num == 11:
        ...
        print ("Ghouls and Ghosts".format(t1, t2))
        tribute1.dead = True
        #tributes.remove(tribute1)
        dead.append(tribute1)
        deadthisday.append(tribute1)
...
def Day():
    ...
    i=0
    while i < (numOfDistricts*2):#for each living tribute...
        othertribs = []
        j=0
        while j < (numOfDistricts*2):
            if tributes[j].dead == True:
                pass
            elif tributes[j] != tributes[i]:
                othertribs.append(tributes[j])
            if (len(tributes) - len(dead)) == 1:
                break
            j += 1
        if (len(othertribs)>0):
            rTrib = random.randint(0,len(othertribs)-1)#pick a random target tribute
            if tributes[i].dead == False:
                pickRandomAction(tributes[i], othertribs[rTrib])
        i += 1
        #print("dead : {} alive: {}".format(len(dead), len(tributes)))    
...
while True:
    initialize()
    while len(tributes) - len(dead) != 1: #As long as there is more than 1 tribute remaining
        Day() #Start a new day
        input() 
        if (len(tributes) - len(dead)) == 1: #If there is only 1 tribute left
    ...
    for i in range(len(tributes)):
        ...
        if tributes[i].dead == False:
            print ("{} from District {} survived the Hunger Games!".format(tributes[i].name, tributes[i].district))
    input()
